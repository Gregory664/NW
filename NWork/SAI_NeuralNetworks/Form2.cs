        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            while (kErr > kErrNorm)
            {
                ...
                for (currPos = 0; currPos < txtLernFiles.Lines.Count() - 1; currPos++)
                {
                    ...
                    //ПОИСК СРЕДНЕГО ЗНАЧЕНИЯ ДЛЯ ПАРЫ Х,У
                    double mean = 0;
                    ...
                    //массив ошибок здесь должен быть массив ошибок
                    double[] E;
                    E = new double[txtLernFiles.Lines.Count()];
                    E[currPos] = NET.ByesLernNW(X, Y, kLern);

                    //меняем веса
                    NET.weight(X, Y, E, mean);
